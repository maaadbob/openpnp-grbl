...
// Serial baud rate
#define BAUD_RATE 9600  // reduced from 115200 to be reliable with Arduino Mega2560

// Default cpu mappings. Grbl officially supports the Arduino Uno only. Other processor types
// may exist from user-supplied templates or directly user-defined in cpu_map.h
#define CPU_MAP_ATMEGA2560 // (Arduino Mega 2560) Working @EliteEng & @Southern-Assemblies-Ltd
...
#define HOMING_CYCLE_0 (1<<X_AXIS)  // OPTIONAL: Then move X axis
#define HOMING_CYCLE_1 (1<<Y_AXIS)  // OPTIONAL: lastly move Y axis
