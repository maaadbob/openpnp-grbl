...
#
# Usage:
# make clean // clean out make files
# make       // build software
# make flash // program the embedded module
#

DEVICE     ?= atmega2560
PROG_DEVICE ?= m2560
CLOCK      = 16000000
PROGRAMMER ?= -c wiring -P /dev/ttyACM0
...
AVRDUDE = avrdude $(PROGRAMMER) -p $(PROG_DEVICE) -b 115200 -D -e -v
