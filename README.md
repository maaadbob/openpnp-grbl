...
***
##Update Summary for v0.97 from v0.9g
  - OpenPnP needs a float for version number, so 0.9g becomes 0.97.  'G' being the 7th letter into the alphabet. :)
  - Additional axis 'C' added.
  - Baud rate lowered to 9600
